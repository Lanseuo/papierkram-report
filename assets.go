...
var _staticMainJs = []byte(`alert("Hallo Welt!")`)

func staticMainJsBytes() ([]byte, error) {
	return _staticMainJs, nil
}
...
func staticMainJs() (*asset, error) {
	...
	info := bindataFileInfo{name: "static/main.js", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _staticStyleCss = []byte(``)
